...
namespace DistantLands.Lumen.EditorScripts
{
    ...
    public class LumenEffectPlayerEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualElement conditionalSettings = new VisualElement();
            conditionalSettings.style.display = effectPlayer.profile && effectPlayer.profile.layers.Any(x => x is DynamicRayLayer) ? DisplayStyle.Flex : DisplayStyle.None;
            conditionalSettings.AddToClassList("verticalBreak");
            localSettings.Add(conditionalSettings);
